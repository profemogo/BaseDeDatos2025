...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_captura_colibri_localidad') != 0
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_captura_colibri_estatus') != 0	
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_captura_colibri_idespecie') != 0
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_body_molt') != 0 
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_ff_molt') != 0
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_WRP') != 0	
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_sexo') != 0
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_cor_pico') != 0
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_grasa') != 0	
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_musculo') != 0
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_protuberancia_cloacal') != 0		
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_registro_colibri_parche_reproductivo') != 0		
...
IF(select COUNT (*) from sys.foreign_keys where name = 'FK_captura_colibri_anillador') != 0		
